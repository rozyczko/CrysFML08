submodule (CFML_Wraps) Wraps_SXTAL_Geom
    ...
    Module Subroutine Wrap_psd_val_type(py_var,for_var,ierror)
    ...
    Module Subroutine Wrap_sxd_val_type(py_var,for_var,ierror)
    ...
    Module Subroutine Wrap_twin_type(py_var,for_var,ierror)
