macro(set_compiler_flags)
    ...
    if(WIN32)
        ...
        elseif(COMPILER_NAME STREQUAL gfortran)
            ...
            if(CMAKE_BUILD_TYPE STREQUAL Debug)
                set(OPT_FLAGS0 "-O0 -std=f2008 -Wall -Wno-maybe-uninitialized -Wno-conversion -Wno-character-truncation -fbacktrace -fdec-math -ffree-line-length-0 -fall-intrinsics -fmax-stack-var-size=8")
                set(OPT_FLAGS1 "-O0 -std=f2008 -Wall -Wno-maybe-uninitialized -Wno-conversion -Wno-character-truncation -fbacktrace -fdec-math -ffree-line-length-0 -fall-intrinsics -fmax-stack-var-size=8")
            elseif(CMAKE_BUILD_TYPE STREQUAL Release)
                set(OPT_FLAGS0 "-O0 -std=f2008 -ffree-line-length-0 -fdec-math -fall-intrinsics -fmax-stack-var-size=8")
                set(OPT_FLAGS1 "-O0 -std=f2008 -ffree-line-length-0 -fdec-math -fall-intrinsics -fmax-stack-var-size=8")
            endif()
            set(OPT_FLAGS2 "")
        endif()
    elseif(UNIX)
