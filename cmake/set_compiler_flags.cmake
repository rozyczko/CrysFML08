    ...
    if(WIN32)
        ...
        elseif(COMPILER_NAME STREQUAL gfortran)
            ...
            if(CMAKE_BUILD_TYPE STREQUAL Debug)
                ...
                set(OPT_FLAGS0 "-O0 -std=f2008 -Wall -Wno-maybe-uninitialized -Wno-conversion -Wno-character-truncation -fbacktrace -fdec-math -ffree-line-length-0 -fall-intrinsics -fPIC -frecursive")
                set(OPT_FLAGS1 "-O0 -std=f2008 -Wall -Wno-maybe-uninitialized -Wno-conversion -Wno-character-truncation -fbacktrace -fdec-math -ffree-line-length-0 -fall-intrinsics -fPIC -frecursive")

            # Windows + gfortran + Release
            elseif(CMAKE_BUILD_TYPE STREQUAL Release)
                message(STATUS "_____ Windows + gfortran + Release _____")

                set(OPT_FLAGS0 "-O0 -std=f2008 -ffree-line-length-0 -fdec-math -fall-intrinsics -fPIC -frecursive")
                set(OPT_FLAGS1 "-O0 -std=f2008 -ffree-line-length-0 -fdec-math -fall-intrinsics -fPIC -frecursive")
    ...
    elseif(UNIX)
        ...
        elseif(COMPILER_NAME STREQUAL gfortran)
            ...
            if(CMAKE_BUILD_TYPE STREQUAL Debug)
                ...
                set(CMAKE_Fortran_FLAGS_DEBUG "-cpp -std=f2008 -Wall -Wno-maybe-uninitialized -Wno-conversion -Wno-character-truncation -fbacktrace -fdec-math -ffree-line-length-none -fPIC -fall-intrinsics -frecursive")
                set(OPT_FLAGS0 "-O0")
                set(OPT_FLAGS1 "-O0")
            ...
            elseif(CMAKE_BUILD_TYPE STREQUAL Release)
                ...
                set(CMAKE_Fortran_FLAGS_RELEASE "-cpp -std=f2008 -ffree-line-length-none -fPIC -fdec-math -fall-intrinsics -frecursive")
                set(OPT_FLAGS0 "-O0")
                set(OPT_FLAGS1 "-O0")
