    ...
    if(WIN32)
        ...
        elseif(COMPILER_NAME STREQUAL gfortran)
            ...
            elseif(CMAKE_BUILD_TYPE STREQUAL Release)
                ...
                set(OPT_FLAGS1 "-O0 -std=f2008 -ffree-line-length-0 -fdec-math -fall-intrinsics")
            endif()
            set(OPT_FLAGS2 "")
        endif()
    elseif(UNIX)
        ...
        if(COMPILER_NAME STREQUAL gfortran)
            ...
            if(CMAKE_BUILD_TYPE STREQUAL Debug)
	            set(CMAKE_Fortran_FLAGS_DEBUG "-cpp -std=f2008 -Wall -Wno-maybe-uninitialized -Wno-conversion -Wno-character-truncation -fbacktrace -fdec-math -ffree-line-length-0 -fPIC -fall-intrinsics -fno-stack-arrays")
                set(OPT_FLAGS0 "-O0")
                set(OPT_FLAGS1 "-O0")
              elseif(CMAKE_BUILD_TYPE STREQUAL Release)
		        set(CMAKE_Fortran_FLAGS_RELEASE "-cpp -std=f2008 -ffree-line-length-0 -fPIC -fdec-math -fall-intrinsics -fno-stack-arrays")
                set(OPT_FLAGS0 "-O0")
                set(OPT_FLAGS1 "-O0")
            endif()
